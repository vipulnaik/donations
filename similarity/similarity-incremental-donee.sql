...
drop table if exists donee_donor_pairs;
drop table if exists donee_donor_pairs_2;
...
/* begin */
    /* delete from donee_donor_pairs where donee=@dne; */
    ...
    from donations where donee=@dne group by donee, donor;

    /* delete from donee_donor_pairs_2 where donee=@dne; */
    create table donee_donor_pairs_2 as
    select
        donee,
        donor,
        coalesce(sum(amount), 0) as total_donation,
    ...
    select
        donee_donor_pairs.donee as first_donee,
        donee_donor_pairs_2.donee as second_donee,
        donee_donor_pairs.donor as donor,
        donee_donor_pairs.total_donation as first_donee_total,
        donee_donor_pairs_2.total_donation as second_donee_total,
        donee_donor_pairs.num_donations as first_num_donations,
        donee_donor_pairs_2.num_donations as second_num_donations
    from donee_donor_pairs
    left join donee_donor_pairs_2 on
        donee_donor_pairs.donor = donee_donor_pairs_2.donor
        ...
        and (donee_donor_pairs.donee=@dne or donee_donor_pairs_2.donee=@dne)
    where donee_donor_pairs.donee=@dne or donee_donor_pairs_2.donee=@dne;
    ...
    from donee_donor_pairs where donee=@dne group by donee;

    /* delete from donee_summary_2 where donee=@dne; */
    create table donee_summary_2 as
    select
        donee,
        count(distinct donor) as donor_count,
        sqrt(sum(power(total_donation, 2))) as weighted_magnitude
    ...
    /* delete from sim_pre where first_donee=@dne or second_donee=@dne; */
    create table donee_sim_pre as
    select
        first_donee,
        second_donee,
        (select count(distinct donor) from donee_donor_pairs
    ...
    /* delete from sim where first_donee=@dne or second_donee=@dne; */
    ...
    /* delete from similarity where first_donee=@dne or second_donee=@dne; */
