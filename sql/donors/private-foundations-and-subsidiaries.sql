insert into donors(donor, donor_type, other_names, country, facebook_username, website, donations_url, lesswrong_username, linkedin_username, affiliated_orgs, eaf_username, eahub_username, github_username, twitter_username, predictionbook_username, philosophy_url, grant_application_process_url, donations_data_update_regularity, donations_data_dlw_update_regularity, donations_data_update_lag, donations_data_dlw_update_lag, dlw_data_processing_script, wikipedia_page, best_overview_url, brief_history, brief_donor_focus_notes, grant_decision_logistics_notes, grant_publication_logistics_notes, grant_financing_notes, notes) values
  ...
  ('Effective Altruism Funds: Effective Altruism Infrastructure Fund','Subsidiary','EA Infrastructure Fund|Effective Altruism Infrastructure Fund|EA Meta Fund|EA Community Fund|EAIF','United Kingdom',NULL,'https://app.effectivealtruism.org/funds/ea-community','https://app.effectivealtruism.org/',NULL,NULL,'Centre for Effective Altruism',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'irregular','irregular','months','days',NULL,
  NULL,
  NULL,
  ...
  ('Effective Altruism Funds: Long-Term Future Fund','Subsidiary','Effective Altruism Funds: Long Term Future Fund|Effective Altruism Funds: Far Future Fund|Long-Term Future Fund|LTFF','United Kingdom',NULL,'https://app.effectivealtruism.org/funds/far-future','https://app.effectivealtruism.org/',NULL,NULL,'Centre for Effective Altruism',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'irregular','irregular','months','days',NULL,
  NULL,
  NULL,
  ...
  ('Survival and Flourishing Fund','Subsidiary','SFF','United States',NULL,'https://survivalandflourishing.fund/','https://survivalandflourishing.fund/',NULL,NULL,'Survival and Flourishing Projects',NULL,NULL,NULL,'saf_is_tweeting',NULL,'https://survivalandflourishing.fund/','https://survivalandflourishing.fund/','semiannual refresh','irregular','days','months',NULL,NULL,'https://survivalandflourishing.fund/',
  ...
  /* grant_publication_logistics_notes */ 'At some point after the grant round decisions are finalized, grants are published on the SAF website. https://survivalandflourishing.org/saf-2020-q4 says: "Winners will appear on this page gradually, as their project paperwork is finalized"; so far, only a (partial) list of winners is available for 2020 Q4; no winners for 2021 Q2 have been published on the SAF website.',
