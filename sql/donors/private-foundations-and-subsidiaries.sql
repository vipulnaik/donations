insert into donors(donor, donor_type, other_names, country, facebook_username, website, donations_url, lesswrong_username, linkedin_username, affiliated_orgs, eaf_username, eahub_username, github_username, twitter_username, predictionbook_username, philosophy_url, grant_application_process_url, donations_data_update_regularity, donations_data_dlw_update_regularity, donations_data_update_lag, donations_data_dlw_update_lag, dlw_data_processing_script, wikipedia_page, best_overview_url, brief_history, brief_donor_focus_notes, grant_decision_logistics_notes, grant_publication_logistics_notes, grant_financing_notes, notes) values
  ...
  'Open Philanthropy (Open Phil for short) spun off from GiveWell, starting as GiveWell Labs in 2011, beginning to make strong progress in 2013, and formally separating from GiveWell as the "Open Philanthropy Project" in June 2017. In 2020, it started going by "Open Philanthropy" dropping the "Project" word.',
  'Open Philanthropy is focused on openness in two ways: open to ideas about cause selection, and open in explaining what they are doing. It has endorsed "hits-based giving" and is working on areas of AI risk, biosecurity and pandemic preparedness, and other global catastrophic risks, criminal justice reform (United States), animal welfare, and some other areas.',
  ...
  NULL,
  'The foundation was included because it has been mentioned by Open Philanthropy as one of the important funders of criminal justice reform in the United States, see for instance https://www.openphilanthropy.org/focus/us-policy/criminal-justice-reform/criminal-justice-reform-strategy'),
  ...
  ('Effective Altruism Funds: Infrastructure Fund','Subsidiary',NULL,'United Kingdom',NULL,'https://app.effectivealtruism.org/funds/ea-community','https://app.effectivealtruism.org/',NULL,NULL,'Centre for Effective Altruism',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'irregular','irregular','months','days',NULL,
  NULL,
  NULL,
  ...
  ('Effective Altruism Funds: Long-Term Future Fund','Subsidiary','Effective Altruism Funds: Long Term Future Fund|Effective Altruism Funds: Far Future Fund','United Kingdom',NULL,'https://app.effectivealtruism.org/funds/far-future','https://app.effectivealtruism.org/',NULL,NULL,'Centre for Effective Altruism',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'irregular','irregular','months','days',NULL,
  NULL,
  NULL,
  /* brief_history */ 'This is one of four Effective Altruism Funds that are a program of the Centre for Effective Altruism (CEA). The creation of the funds was inspired by the success of the EA Giving Group donor-advised fund run by Nick Beckstead, and also by the donor lottery run in December 2016 by Paul Christiano and Carl Shulman (see https://forum.effectivealtruism.org/posts/WvPEitTCM8ueYPeeH/donor-lotteries-demonstration-and-faq for more). EA Funds were introduced on 2017-02-09 in the post https://forum.effectivealtruism.org/posts/a8eng4PbME85vdoep/introducing-the-ea-funds and launched in the post https://forum.effectivealtruism.org/posts/iYoSAXhodpxJFwdQz/ea-funds-beta-launch on 2017-02-28. The first round of allocations was announced at https://forum.effectivealtruism.org/posts/MsaS8JKrR8nnxyPkK/update-on-effective-altruism-funds on 2017-04-20. The funds allocation information appears to have next been updated in November 2017; see https://www.facebook.com/groups/effective.altruists/permalink/1606722932717391/ for more. This particular fund was previously called the Far Future Fund; it was renamed to the Long-Term Future Fund to more accurately reflect the meaning.',
  ...
  ('Survival and Flourishing Fund','Subsidiary','SFF','United States',NULL,'https://survivalandflourishing.fund/','https://survivalandflourishing.fund/',NULL,NULL,'Survival and Flourishing',NULL,NULL,NULL,NULL,NULL,'https://survivalandflourishing.fund/','https://survivalandflourishing.fund/','semiannual refresh','irregular','days','months',NULL,NULL,'https://survivalandflourishing.fund/',
  ...
  'The £500,000 budget for the first year of Effective Altruism Grants was part of the Centre for Effective Altruism budget, and the costs are covered by the Open Philanthropy grant https://www.openphilanthropy.org/giving/grants/centre-effective-altruism-general-support and a couple of other private donors, as described at http://effective-altruism.com/ea/1fc/effective_altruism_grants_project_update/',
  NULL),
