insert into donations(donor, donee, amount, fraction, donation_date, donation_date_precision, donation_date_basis,
    ...
    ('Ben Kuhn', 'Against Malaria Foundation', 200.00, NULL, '2013-07-06', 'day', 'donation log', 'Global health/malaria', 'http://www.benkuhn.net/ea/', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
