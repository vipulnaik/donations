...
insert into donations(donor, donee, amount, fraction, donation_date, donation_date_precision, donation_date_basis, cause_area, url, notes, influencer) values
  ('Eric Rogstad', 'LessWrong 2.0', 10000, NULL, '2017-09-14', 'day', 'date of donation announcement', 'Rationality improvement', 'https://www.lesswrong.com/posts/rEHLk9nC5TtrNoAKT/lw-2-0-strategic-overview', NULL, NULL);
