...
insert into donations(donor,donee,donation_earmark,amount,donation_date,donation_date_precision,donation_date_basis,cause_area,url,notes) values
    ...
    ,('Berkeley Existential Risk Initiative','Ben Goldhaber',NULL,150000,'2018-10-10','day','donation log','AI safety','https://web.archive.org/web/20181019174535/http://existence.org/grants-list/','“to support his project (co-lead by Jacob L) to bring x-risk-relevant questions to popular prediction platforms”')
