...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision, donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ...
  /* donor_donee_reason */ NULL,
  /* donor_amount_reason */ NULL,
  /* donor_timing_reason */ 'Timing determined by timing of grant round; this is SFF''s seventh grant round and the first with a grant to this grantee.',
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ 'The future round https://survivalandflourishing.fund/sff-2023-h1-recommendations includes a grant recommendation to Redwood Research for $1,098,000, suggesting satisfaction with the grant outcome.',
  /* notes */ NULL);

  /* Another grant in 2023 H1 to Redwood Research but its split
  between the two donors (Jaan Tallinn and Future of Life Institute)
  is not yet clear; FLI's site accounts for $500,000 of the $1,098,000
  */
...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision,donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ('Survival and Flourishing Fund','Center for Applied Rationality',110000,'2019-09-05','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Alex Flint|Andrew Critch|Eric Rogstad','2019-08-29','day','https://github.com/survivalandflourishing/survivalandflourishing.github.io/blob/cc4ba1e3975f4e4847272ffaf72a6ce09c19648f/_data/recommendations.tsv',880000,0.125,
  ...
  ('Survival and Flourishing Fund','Center for Applied Rationality',150000,'2019-12-05','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Alex Flint|Alex Zhu|Andrew Critch|Eric Rogstad|Oliver Habryka','2019-12-15','day','https://github.com/survivalandflourishing/survivalandflourishing.github.io/blob/aa47e9860dff38e2af8d08da56a0a13389a75af4/_data/recommendations.tsv',920000,0.163,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2019 Q4 grants https://survivalandflourishing.fund/sff-2019-q4-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Funders were free to assign different weights to different Recommenders in the process; the weights were determined by marginal utility functions specified by the funders (Jaan Tallinn and SFF). In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  ('Jaan Tallinn','Center for Applied Rationality',50000,'2019-12-04','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Alex Flint|Alex Zhu|Andrew Critch|Eric Rogstad|Oliver Habryka','2019-12-15','day','https://github.com/survivalandflourishing/survivalandflourishing.github.io/blob/aa47e9860dff38e2af8d08da56a0a13389a75af4/_data/recommendations.tsv',1090000,0.0459,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2019 Q4 grants https://survivalandflourishing.fund/sff-2019-q4-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Funders were free to assign different weights to different Recommenders in the process; the weights were determined by marginal utility functions specified by the funders (Jaan Tallinn and SFF). In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  ('Survival and Flourishing Fund','Center for Applied Rationality',212000,'2021-03-10','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Oliver Habryka|Eric Rogstad',NULL,NULL,NULL,650000,0.3262,
  ...
  ('Jed McCaleb','Center for Applied Rationality',23000,'2020-10-01','quarter','donation log','Epistemic institutions','https://survivalandflourishing.fund/sff-2020-h2-recommendations','Survival and Flourishing Fund|Oliver Habryka|Eric Rogstad',NULL,NULL,NULL,250000,0.092,
  ...
  ('Jaan Tallinn','Center for Applied Rationality',39000,'2020-12-08','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Oliver Habryka|Eric Rogstad',NULL,NULL,NULL,NULL,NULL,
  ...
  ('Jaan Tallinn','Center for Applied Rationality',1207000,'2021-07-28','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone',NULL,NULL,NULL,9513000,0.1269,
  ...
  ('Jaan Tallinn','Center for Applied Rationality',450000,'2022-12-08','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Nick Hay|Alyssa Vance|Scott Garrabrant',NULL,NULL,NULL,NULL,NULL,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2022 H2 grants https://survivalandflourishing.fund/sff-2022-h2-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a table of marginal value functions. Recommenders specified a marginal value function for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different value functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision,donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ...
  ('Jaan Tallinn','AI Impacts',221000,'2021-07-23','day','donation log','AI safety','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone',NULL,NULL,NULL,9513000,0.0232,
   /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants https://survivalandflourishing.fund/sff-2021-h1-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision,donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ('Survival and Flourishing Fund','Lightcone Infrastructure',260000,'2019-09-30','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Alex Flint|Andrew Critch|Eric Rogstad','2019-08-29','day','https://github.com/survivalandflourishing/survivalandflourishing.github.io/blob/cc4ba1e3975f4e4847272ffaf72a6ce09c19648f/_data/recommendations.tsv',880000,0.2955,
  ...
  ('Survival and Flourishing Fund','Lightcone Infrastructure',290000,'2020-06-09','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Alex Zhu|Andrew Critch|Jed McCaleb|Oliver Habryka',NULL,NULL,NULL,650000,0.4461,
  ...
  ('Jaan Tallinn','Lightcone Infrastructure',110000,'2020-06-12','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Alex Zhu|Andrew Critch|Jed McCaleb|Oliver Habryka',NULL,NULL,NULL,920000,0.1196,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2020 H1 grants https://survivalandflourishing.fund/sff-2020-h1-recommendations based on the S-process (simulation process). A request for grants was made at https://forum.effectivealtruism.org/posts/wQk3nrGTJZHfsPHb6/survival-and-flourishing-grant-applications-open-until-march and open till 2020-03-07. The S-process "involves allowing the recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Funders were free to assign different weights to different recommenders in the process; the weights were determined by marginal utility functions specified by the funders (Jaan Tallinn, Jed McCaleb, and SFF). In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  ('Jed McCaleb','Lightcone Infrastructure',30000,'2020-04-01','quarter','donation log','Epistemic institutions','https://survivalandflourishing.fund/sff-2020-h1-recommendations','Survival and Flourishing Fund|Alex Zhu|Andrew Critch|Jed McCaleb|Oliver Habryka',NULL,NULL,NULL,250000,0.12,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2020 H1 grants based on the S-process (simulation process). A request for grants was made at https://forum.effectivealtruism.org/posts/wQk3nrGTJZHfsPHb6/survival-and-flourishing-grant-applications-open-until-march and open till 2020-03-07. The S-process "involves allowing the recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Funders were free to assign different weights to different recommenders in the process; the weights were determined by marginal utility functions specified by the funders (Jaan Tallinn, Jed McCaleb, and SFF). In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  ('Jaan Tallinn','Lightcone Infrastructure',1055000,'2021-04-01','quarter','donation log','Epistemic institutions','https://survivalandflourishing.fund/sff-2021-h1-recommendations','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone',NULL,NULL,NULL,9513000,0.1109,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  ('Jaan Tallinn','Lightcone Infrastructure',380000,'2021-12-30','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Beth Barnes|Oliver Habryka|Zvi Mowshowitz','2021-11-20','day','https://www.facebook.com/jaan.tallinn/posts/4436719686377948',8858000,0.0429,
  ...
  ('Jaan Tallinn','Lightcone Infrastructure',400000,'2022-08-18','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html',NULL,NULL,NULL,NULL,NULL,NULL,
  /* donation_process */ 'This is a speculation grant ahead of the 2022 H2 grants https://survivalandflourishing.fund/sff-2022-h2-recommendations where a total of $1,000,000 would be allocated; the residual amountof $600,000 would be granted on 2022-12-08.',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  /* donor_donee_reason */ NULL,
  ...
  /* donor_timing_reason */ NULL,
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ 'This speculation grant is validated by the subsequent 2022 H2 grant round https://survivalandflourishing.fund/sff-2022-h2-recommendations where the total amount allocated to the grantee ($1,000,000) exceeds the speculation grant amount ($400,000).',
  /* notes */ NULL),

  ('Jaan Tallinn','Lightcone Infrastructure',600000,'2022-12-08','day','donation log','Epistemic institutions','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Nick Hay|Alyssa Vance|Scott Garrabrant',NULL,NULL,NULL,NULL,NULL,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2022 H2 grants https://survivalandflourishing.fund/sff-2022-h2-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a table of marginal value functions. Recommenders specified a marginal value function for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different value functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  /* donor_donee_reason */ NULL,
  /* donor_amount_reason */ 'A total amount of $1,000,000 is allocated by the SFF process; of this amount, $400,000 was already granted via a speculation grant on 2022-08-18. This leaves a remainder of $600,000 to grant.',
  /* donor_timing_reason */ 'Timing determined by timing of grant round; this is SFF''s eighth grant round.',
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ 'The grant recommendation in the future grant round https://survivalandflourishing.fund/sff-2023-h1-recommendations suggests continued satisfaction with the grantee.',
  /* notes */ NULL),

  ('Jaan Tallinn','Lightcone Infrastructure',1733000,'2023-04-01','quarter','donation log','Epistemic institutions','https://survivalandflourishing.fund/sff-2023-h1-recommendations','Survival and Flourishing Fund|Olle Häggström|Steve Omohundro|Daniel Kokotajlo',NULL,NULL,NULL,NULL,NULL,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2023 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios. In each simulation, Recommenders specify a marginal value function for funding each application, and an algorithm calculates a table of grant recommendations by taking turns distributing funding recommendations from each Recommender in succession, using their marginal value functions to prioritize. The Recommenders then discuss their evaluations and update the simulation with their new opinions, using approval voting to prioritize discussion topics, until the end of the last meeting when their inputs are finalized. Similarly, funders specify and adjust different value functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision,donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ...
  ('Jaan Tallinn','Alliance to Feed the Earth in Disasters',175000,'2021-07-16','day','donation log','Global catastrophic risks','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone',NULL,NULL,NULL,9513000,0.0184,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants https://survivalandflourishing.fund/sff-2021-h1-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  /* notes */ 'Grant made via the Players Philanthropy Fund. Although Jed McCaleb also participates in this grant round as a funder, he does not make any grants to this grantee.'),

  ('Jaan Tallinn','Alliance to Feed the Earth in Disasters',979000,'2021-12-16','day','donation log','Global catastrophic risks','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Beth Barnes|Oliver Habryka|Zvi Mowshowitz','2021-11-20','day','https://www.facebook.com/jaan.tallinn/posts/4436719686377948',8858000,0.1105,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H2 grants https://survivalandflourishing.fund/sff-2021-h2-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a table of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts. [...] [The] system is designed to generally favor funding things that at least one recommender is excited to fund, rather than things that every recommender is excited to fund." https://www.lesswrong.com/posts/kuDKtwwbsksAW4BG2/zvi-s-thoughts-on-the-survival-and-flourishing-fund-sff explains the process from a recommender''s perspective.',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision, donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ('Jaan Tallinn','Centre for Long-Term Resilience',1013000,'2021-04-01','quarter','donation log','Global catastrophic risks','https://survivalandflourishing.fund/sff-2021-h1-recommendations','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone',NULL,NULL,NULL,9513000,0.1065,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision,donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ...
  ('Jaan Tallinn','Charter Cities Institute',137000,'2021-07-16','day','donation log','Alternate governance/charter cities','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone',NULL,NULL,NULL,9513000,0.0144,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants https://survivalandflourishing.fund/sff-2021-h1-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  /* notes */ 'Although Jed McCaleb also participates in this grant round as a funder, he does not make any grants to this grantee. In Jaan Tallinn''s donation log, the donation shows up as being to the "Center for Innovative Governance Research" (this is the organization''s formal name); the SFF website states it as being to the Charter Cities Institute.'),

  ('Jaan Tallinn','Charter Cities Institute',261000,'2022-06-23','day','donation log','Alternate governance/charter cities','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Nell Watson|Malo Bourgon|Catherine Olsson',NULL,NULL,NULL,NULL,NULL,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2022 H1 grants https://survivalandflourishing.fund/sff-2022-h1-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a table of marginal value functions. Recommenders specified a marginal value function for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different value functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ NULL,
  /* notes */ 'The grantee is recorded as "Center for Innovative Governance Research" in Jaan Tallinn''s donation log; this is the organization''s formal name.'),

  ('Jaan Tallinn','Charter Cities Institute',315000,'2023-04-01','quarter','donation log','Alternate governance/charter cities','https://survivalandflourishing.fund/sff-2023-h1-recommendations','Survival and Flourishing Fund|Olle Häggström|Steve Omohundro|Daniel Kokotajlo',NULL,NULL,NULL,NULL,NULL,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2023 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios. In each simulation, Recommenders specify a marginal value function for funding each application, and an algorithm calculates a table of grant recommendations by taking turns distributing funding recommendations from each Recommender in succession, using their marginal value functions to prioritize. The Recommenders then discuss their evaluations and update the simulation with their new opinions, using approval voting to prioritize discussion topics, until the end of the last meeting when their inputs are finalized. Similarly, funders specify and adjust different value functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision,donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ('Jaan Tallinn','AI Safety Support',200000,'2021-04-01','quarter','donation log','AI safety','https://survivalandflourishing.fund/sff-2021-h1-recommendations','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone',NULL,NULL,NULL,9513000,0.0210,
   /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
...
/* Grants to AI Objectives Institute */

insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision,donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ('Jaan Tallinn','AI Objectives Institute',485000,'2021-10-01','quarter','donation log','AI safety','https://survivalandflourishing.fund/sff-2021-h2-recommendations','Survival and Flourishing Fund|Beth Barnes|Oliver Habryka|Zvi Mowshowitz','2021-11-20','day','https://www.facebook.com/jaan.tallinn/posts/4436719686377948',8858000,0.0548,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H2 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a table of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts. [...] [The] system is designed to generally favor funding things that at least one recommender is excited to fund, rather than things that every recommender is excited to fund." https://www.lesswrong.com/posts/kuDKtwwbsksAW4BG2/zvi-s-thoughts-on-the-survival-and-flourishing-fund-sff explains the process from a recommender''s perspective.',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_announcement_date, donation_announcement_date_precision,donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ('Jaan Tallinn','Convergence Analysis',10000,'2020-06-29','day','donation log','Global catastrophic risks','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Alex Zhu|Andrew Critch|Jed McCaleb|Oliver Habryka',NULL,NULL,NULL,920000,0.0109,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2020 H1 grants https://survivalandflourishing.fund/sff-2020-h1-recommendations based on the S-process (simulation process). A request for grants was made at https://forum.effectivealtruism.org/posts/wQk3nrGTJZHfsPHb6/survival-and-flourishing-grant-applications-open-until-march and open till 2020-03-07. The S-process "involves allowing the recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Funders were free to assign different weights to different recommenders in the process; the weights were determined by marginal utility functions specified by the funders (Jaan Tallinn, Jed McCaleb, and SFF). In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
...
/* Grants to Berkeley Existential Risk Initiative */

insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, influencer, donation_earmark, donation_announcement_date, donation_announcement_date_precision,donation_announcement_url, goal_amount, fraction, donation_process, intended_use_of_funds_category, intended_use_of_funds, intended_funding_timeframe_in_months, donor_donee_reason, donor_amount_reason, donor_timing_reason, donor_next_donation_thoughts, donor_retrospective, notes) values
  ('Jaan Tallinn','Berkeley Existential Risk Initiative',20000,'2020-06-11','day','donation log','Gobal catastrophic risks','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Alex Zhu|Andrew Critch|Jed McCaleb|Oliver Habryka','Centre for the Study of Existential Risk',NULL,NULL,NULL,920000,0.0218,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2020 H1 grants https://survivalandflourishing.fund/sff-2020-h1-recommendations based on the S-process (simulation process). A request for grants was made at https://forum.effectivealtruism.org/posts/wQk3nrGTJZHfsPHb6/survival-and-flourishing-grant-applications-open-until-march and open till 2020-03-07. The S-process "involves allowing the recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Funders were free to assign different weights to different recommenders in the process; the weights were determined by marginal utility functions specified by the funders (Jaan Tallinn, Jed McCaleb, and SFF). In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Direct project expenses',
  ...
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ NULL,
  /* notes */ 'Although the Survival and Flourishing Fund and Jed McCaleb also participate as funders in this grant round, neither of them makes a grant to the grantee. SFF itself is a descendant of BERI''s now-ended grantmaking, which is distinct from BERI''s academic collaboration work that is still ongoing and being funded by this grant.'),

  /* https://jaan.online/philanthropy/donations.html also lists a grant to BERI for Haydn Belfield's M.Sc.; skipping entry for that here! It does not seem to be based on the SFF process */

  ('Jaan Tallinn','Berkeley Existential Risk Initiative',247000,'2021-01-05','day','donation log','Global catastrophic risks','https://jaan.online/philanthropy/donations.html','Survival and Flourishing Fund|Oliver Habryka|Eric Rogstad',NULL,NULL,NULL,NULL,2705000,0.0274,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2020 H2 grants https://survivalandflourishing.fund/sff-2020-h2-recommendations based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Organizational general support',
  /* intended_use_of_funds */ NULL,
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  ('Jaan Tallinn','Berkeley Existential Risk Initiative',478000,'2021-04-01','quarter','donation log','Global catastrophic risks','https://survivalandflourishing.fund/sff-2021-h1-recommendations','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone','Future of Humanity Institute',NULL,NULL,NULL,9513000,0.0502,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Direct project expenses',
  /* intended_use_of_funds */ 'Grant to support the BERI-FHI collaboration, This is BERI''s collaboration with the Future of Humanity Institute (FHI). See https://existence.org/collaborations/ for BERI''s full list of collaborations.',
  /* intended_funding_timeframe_in_months */ NULL,
  /* donor_donee_reason */ NULL,
  /* donor_amount_reason */ NULL,
  /* donor_timing_reason */ 'Timing determined by timing of grant round; this is SFF''s fifth grant round and the third with grants to the grantee. It is the first round with a grant specifically for this collaboration.',
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ NULL,
  /* notes */ 'The grant round includes grants from Tallinn for two other BERI collaborations (with SERI and CSER) as well as grants from Jed McCaleb for the collaborations with FHI and SERI.'),

  ('Jaan Tallinn','Berkeley Existential Risk Initiative',333000,'2021-04-01','quarter','donation log','Global catastrophic risks','https://survivalandflourishing.fund/sff-2021-h1-recommendations','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone','Stanford Existential Risk Initiative',NULL,NULL,NULL,9513000,0.035,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Direct project expenses',
  /* intended_use_of_funds */ 'Grant to support the BERI-SERI collaboration, This is BERI''s collaboration with the Stanford Existential Risk Institute (SERI). See https://existence.org/collaborations/ for BERI''s full list of collaborations.',
  /* intended_funding_timeframe_in_months */ NULL,
  /* donor_donee_reason */ NULL,
  /* donor_amount_reason */ NULL,
  /* donor_timing_reason */ 'Timing determined by timing of grant round; this is SFF''s fifth grant round and the third with grants to the grantee. It is the first round with a grant specifically for this collaboration.',
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ NULL,
  /* notes */ 'The grant round includes grants from Tallinn for two other BERI collaborations (with FHI and CSER) as well as grants from Jed McCaleb for the collaborations with FHI and SERI.'),

  ('Jaan Tallinn','Berkeley Existential Risk Initiative',37000,'2021-04-01','quarter','donation log','Global catastrophic risks','https://survivalandflourishing.fund/sff-2021-h1-recommendations','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone','Centre for the Study of Existential Risk',NULL,NULL,NULL,9513000,0.0039,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Direct project expenses',
  /* intended_use_of_funds */ 'Grant to support the BERI-CSER collaboration, This is BERI''s collaboration with the Centre for the Study of Existential Risk (CSER). See https://existence.org/collaborations/ for BERI''s full list of collaborations.',
  /* intended_funding_timeframe_in_months */ NULL,
  /* donor_donee_reason */ NULL,
  /* donor_amount_reason */ NULL,
  /* donor_timing_reason */ 'Timing determined by timing of grant round; this is SFF''s fifth grant round and the third with grants to the grantee. It is the second round with a grant specifically for this collaboration.',
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ NULL,
  /* notes */ 'The grant round includes grants from Tallinn for two other BERI collaborations (with FHI and SERI) as well as grants from Jed McCaleb for the collaborations with FHI and SERI.'),

  ('Jed McCaleb','Berkeley Existential Risk Initiative',17000,'2021-04-01','quarter','donation log','Global catastrophic risks','https://survivalandflourishing.fund/sff-2021-h1-recommendations','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone','Future of Humanity Institute',NULL,NULL,NULL,243000,0.07,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Direct project expenses',
  /* intended_use_of_funds */ 'Grant to support the BERI-FHI collaboration, This is BERI''s collaboration with the Future of Humanity Institute (FHI). See https://existence.org/collaborations/ for BERI''s full list of collaborations.',
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ NULL,
  /* notes */ 'The grant round includes a grant from Jed McCaleb for another BERI collaboration (with SERI) and grants from Tallinn for collaborations with FHI, SERI, and CSER.'),

  ('Jed McCaleb','Berkeley Existential Risk Initiative',14000,'2021-04-01','quarter','donation log','Global catastrophic risks','https://survivalandflourishing.fund/sff-2021-h1-recommendations','Survival and Flourishing Fund|Ben Hoskin|Katja Grace|Oliver Habryka|Adam Marblestone','Stanford Existential Risk Initiative',NULL,NULL,NULL,243000,0.0576,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H1 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a spreadsheet of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts."',
  /* intended_use_of_funds_category */ 'Direct project expenses',
  /* intended_use_of_funds */ 'Grant to support the BERI-SERI collaboration, This is BERI''s collaboration with the Stanford Existential Risk Initiative (SERI). See https://existence.org/collaborations/ for BERI''s full list of collaborations.',
  /* intended_funding_timeframe_in_months */ NULL,
  /* donor_donee_reason */ NULL,
  /* donor_amount_reason */ NULL,
  /* donor_timing_reason */ 'Timing determined by timing of grant round; this is SFF''s fifth grant round and the third with grants to the grantee. It is the first round with a grant specifically for this collaboration.',
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ NULL,
  /* notes */ 'The grant round includes a grant from Jed McCaleb for another BERI collaboration (with FHI) and grants from Tallinn for collaborations with FHI, SERI, and CSER.'),

  ('Jaan Tallinn','Berkeley Existential Risk Initiative',248000,'2021-10-01','quarter','donation log','AI safety','https://survivalandflourishing.fund/sff-2021-h2-recommendations','Survival and Flourishing Fund|Beth Barnes|Oliver Habryka|Zvi Mowshowitz','Center for Human-Compatible AI','2021-11-20','day','https://www.facebook.com/jaan.tallinn/posts/4436719686377948',8858000,0.028,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H2 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a table of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts. [...] [The] system is designed to generally favor funding things that at least one recommender is excited to fund, rather than things that every recommender is excited to fund." https://www.lesswrong.com/posts/kuDKtwwbsksAW4BG2/zvi-s-thoughts-on-the-survival-and-flourishing-fund-sff explains the process from a recommender''s perspective.',
  /* intended_use_of_funds_category */ 'Direct project expenses',
  /* intended_use_of_funds */ 'Grant to support the BERI-CHAI collaboration, This is BERI''s collaboration with the Center for Human-Compatible AI (CHAI). See https://existence.org/collaborations/ for BERI''s full list of collaborations.',
  /* intended_funding_timeframe_in_months */ NULL,
  /* donor_donee_reason */ NULL,
  /* donor_amount_reason */ NULL,
  /* donor_timing_reason */ 'Timing determined by timing of grant round; this is SFF''s sixth grant round and the fourth with grants to the grantee. It is the first round with a grant specifically for this collaboration.',
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ NULL,
  /* notes */ 'Jed McCaleb makes a $250,000 grant to BERI in this grant round for the same collaboration (BERI-CHAI). The Casey and Family Foundation, that also participates as a funder in this grant round, does not make any grants to BERI.'),

  ('Jed McCaleb','Berkeley Existential Risk Initiative',250000,'2021-10-01','quarter','donation log','AI safety','https://survivalandflourishing.fund/sff-2021-h2-recommendations','Survival and Flourishing Fund|Beth Barnes|Oliver Habryka|Zvi Mowshowitz','Center for Human-Compatible AI','2021-11-20','day','https://www.facebook.com/jaan.tallinn/posts/4436719686377948',250000,1.0,
  /* donation_process */ 'Part of the Survival and Flourishing Fund''s 2021 H2 grants based on the S-process (simulation process) that "involves allowing the Recommenders and funders to simulate a large number of counterfactual delegation scenarios using a table of marginal utility functions. Recommenders specified marginal utility functions for funding each application, and adjusted those functions through discussions with each other as the round progressed. Similarly, funders specified and adjusted different utility functions for deferring to each Recommender. In this round, the process also allowed the funders to make some final adjustments to decide on their final intended grant amounts. [...] [The] system is designed to generally favor funding things that at least one recommender is excited to fund, rather than things that every recommender is excited to fund." https://www.lesswrong.com/posts/kuDKtwwbsksAW4BG2/zvi-s-thoughts-on-the-survival-and-flourishing-fund-sff explains the process from a recommender''s perspective.',
  /* intended_use_of_funds_category */ 'Direct project expenses',
  /* intended_use_of_funds */ 'Grant to support the BERI-CHAI collaboration, This is BERI''s collaboration with the Center for Human-Compatible AI (CHAI). See https://existence.org/collaborations/ for BERI''s full list of collaborations.',
  /* intended_funding_timeframe_in_months */ NULL,
  ...
  /* donor_next_donation_thoughts */ NULL,
  /* donor_retrospective */ NULL,
  /* notes */ 'Jaan Tallinn makes a $248,00 grant to BERI in this grant round for the same collaboration (BERI-CHAI). The Casey and Family Foundation, that also participates as a funder in this grant round, does not make any grants to BERI.');
