...
insert into donations(donor, donee, amount, fraction, donation_date,
    ...
    ('Blake Borgeson','Machine Intelligence Research Institute',10.0,NULL,'2018-04-07','year','donee contributor list','AI safety','https://web.archive.org/web/20180407192941/https://intelligence.org/topcontributors/',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
