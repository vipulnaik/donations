create table donations (
    ...
    donation_process varchar(2000) DEFAULT NULL,
    intended_use_of_funds_category varchar(200) DEFAULT NULL,
    intended_use_of_funds varchar(2000) DEFAULT NULL,
    intended_funding_timeframe_in_months int(11) DEFAULT NULL,
    donor_donee_reason varchar(2000) DEFAULT NULL,
    donor_amount_reason varchar(2000) DEFAULT NULL,
    donor_timing_reason varchar(2000) DEFAULT NULL,
    donor_next_donation_thoughts varchar(2000) DEFAULT NULL,
    donor_retrospective varchar(2000) DEFAULT NULL,
