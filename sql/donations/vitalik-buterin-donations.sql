...
insert into donations(donor, donee, amount, donation_date, donation_date_precision, donation_date_basis, cause_area, url, notes, payment_modality, match_eligible, employer_match, matching_employer) values
    ...
    ,('Vitalik Buterin','SENS Research Foundation',2400000.0,'2018-02-02','day','date of donation announcement','Life sciences/anti-aging','http://www.sens.org/outreach/press-releases/srf-receives-24m-ethereum-donation-from-vitalik-buterin',NULL,'Ethereum transaction',NULL,NULL,NULL)
    ,('Vitalik Buterin','GiveDirectly',1000000.0,'2018-03-27','day','date of donation announcement','Global poverty','https://givedirectly.org/blog-post?id=1228348992037272486','OmiseGO also contributes to this donation','OMG transaction',NULL,NULL,NULL)
;
