...
insert into donations(donor, donee, amount, fraction, donation_date, donation_date_precision, donation_date_basis, cause_area, url, notes, influencer) values
  # -- 2013
  ('Holden Karnofsky','GiveDirectly',NULL,1.0,'2013-12-12','day','date of donation announcement','Cash transfers','https://blog.givewell.org/2013/12/12/staff-members-personal-donations/','First considers not giving, then makes some argument on why it is better to give. Then looks at confidence multipliers for global health interventions relative to GiveDirectly and thinks they are not robust enough to overcome the case for GiveDirectly','GiveWell'),
  # -- 2014
  ('Holden Karnofsky','GiveWell top charities',NULL,1.0,'2014-12-17','day','date of donation announcement','Global health and cash transfers','https://blog.givewell.org/2014/12/17/staff-members-personal-donations-giving-season-2014/','Giving opportunities in 2014 better than 2013, so giving a bit but to regrant to top charities','GiveWell'),
  # -- 2015
